...
abstract class BaseDbTable implements BaseColumns {
    ...
    protected void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion, String tempName) {
        LogUtils.d(TAG, getName() + ".onUpgrade(oldVersion = " + oldVersion + ", newVersion = " + newVersion + ", tempName = " + tempName + ")");
    ...
    static Collection<String> listTables(SQLiteDatabase db) {
        ...
        cursor.close();
        LogUtils.d(TAG, "listTables(): " + tables);
        return tables;
    }
    ...
    static void dropTable(SQLiteDatabase db, String table) {
        LogUtils.d(TAG, "dropTable(" + table + ")...");
    ...
    static void renameTable(SQLiteDatabase db, String oldName, String newName) {
        LogUtils.d(TAG, "renameTable(" + oldName + ", " + newName + ")...");
    ...
    static void copyTableData(SQLiteDatabase db, String oldTable, String newTable) {
        LogUtils.d(TAG, "copyTableData(" + oldTable + ", " + newTable + ")...");
        //先将新表数据清空
        ...
        LogUtils.d(TAG, "copyTableData: Common columns: " + commonColumns);
