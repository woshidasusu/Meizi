package coder.dasu.meizi.ui.fragment;
...
import coder.dasu.meizi.mode.net.retrofit.GankApi;
...
import coder.dasu.meizi.ui.base.SwipeRefreshFragment;
...
public abstract class GankDataFragment extends SwipeRefreshFragment {
    ...
    private void initVariable() {
        ...
        mServerLatestIssue = MeiziApplication.getConfigSP().getString(AppConstant.GANK_SERVER_LATEST_ISSUE_TIME);
    }
        ...
        call.enqueue(new Callback<GankDataResponse>() {
            ...
            public void onResponse(Call<GankDataResponse> call, Response<GankDataResponse> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    MeiziApplication.getConfigSP().putString(AppConstant.GANK_ANDROID_LATEST_UPDATE_TIME, mServerLatestIssue);
