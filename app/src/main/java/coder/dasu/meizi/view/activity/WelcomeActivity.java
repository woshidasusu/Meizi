...
public class WelcomeActivity extends Activity {
    ...
    private void initVatiable() {
        ...
        mDaoSession = MeiziApp.getDaoSession();
        mLastUpdateDay = MeiziApp.getConfigSP().getString(AppConstant.GANK_DAY_LATEST_UPDATE_TIME, "");
        ...
        return new Callback<GankHistoryResponse>() {
            ...
            public void onResponse(Call<GankHistoryResponse> call, Response<GankHistoryResponse> response) {
                ...
                if (response.isSuccessful()) {
                    MeiziApp.getConfigSP().putString(AppConstant.GANK_DAY_LATEST_UPDATE_TIME, mTodayDate);
                    ...
                    if (!ListUtils.isEmpty(dayList)){
                        ...
                        MeiziApp.getConfigSP().putString(AppConstant.GANK_SERVER_LATEST_ISSUE_TIME,
