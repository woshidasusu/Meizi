...
*/
public class GankDayHistoryDao extends AbstractDao<GankDayHistory, Long> {

    public static final String TABLENAME = "GANK_DAY_HISTORY";

    /**
     * Properties of entity GankDayHistory.<br/>
    ...
    @Override
    protected final void bindValues(DatabaseStatement stmt, GankDayHistory entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, GankDayHistory entity) {
        stmt.clearBindings();
    ...
    @Override
    public GankDayHistory readEntity(Cursor cursor, int offset) {
        GankDayHistory entity = new GankDayHistory( //
    ...
    @Override
    public void readEntity(Cursor cursor, GankDayHistory entity, int offset) {
        entity.setId(cursor.isNull(offset + 0) ? null : cursor.getLong(offset + 0));
        entity.setDay(cursor.isNull(offset + 1) ? null : cursor.getString(offset + 1));
     }
    
    @Override
    protected final Long updateKeyAfterInsert(GankDayHistory entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(GankDayHistory entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(GankDayHistory entity) {
